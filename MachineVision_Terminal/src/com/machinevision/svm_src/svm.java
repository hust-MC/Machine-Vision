package com.machinevision.svm_src;
...
public class svm {
	...
	public static void svm_save_model(String filepath, String model_file_name, svm_model model) throws IOException
	{
		DataOutputStream fp = new DataOutputStream(new BufferedOutputStream(new FileOutputStream(filepath + model_file_name)));
	...
	public static svm_model svm_load_model(String filepath, String model_file_name) throws IOException
	{
		File file = new File(filepath + model_file_name);
		return svm_load_model(new BufferedReader(new FileReader(file)));
	}
